...
- Optional Modem Manager (e.g. StarDoc 134)
...
Enter your WWIVD host and port (e.g. `192.168.1.100` and `8080`), set the refresh interval, and choose which endpoints to enable. Optionally enable Modem Manager with its own host/port.
